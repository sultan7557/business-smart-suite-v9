...
const UserPermissionsPage: React.FC = () => {
  ...
  const handleGrantPermission = async () => {
    try {
      ...
      fetchUserPermissions(); // Refresh permissions list
    } catch (err: any) {
  ...
  if (loading) return <div>Loading user permissions...</div>;
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Permissions for {user.name} ({user.email})</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <h3 className="text-lg font-semibold mt-8 mb-4">Grant New Permission</h3>
          <Dialog open={isGrantPermissionDialogOpen} onOpenChange={setIsGrantPermissionDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>Select a role and optionally an expiry date for the new permission.</DialogDescription>
              </DialogHeader>
