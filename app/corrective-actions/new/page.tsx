...
export default function NewCorrectiveActionPageWrapper() {
  return (
    <Suspense fallback={<Loader overlay message="Loading new corrective action..." />}>
      <NewCorrectiveActionPage />
    </Suspense>
  )
}

async function NewCorrectiveActionPage() {
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to create a category before adding a corrective action.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
  ...
  async function createCorrectiveAction(formData: FormData) {
    ...
    redirect(`/corrective-actions/${correctiveAction.id}`)
  }
  ...
  return (
    <div className="p-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Add New Corrective Action</CardTitle>
          <CardDescription>Create a new corrective action document</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={createCorrectiveAction} className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <textarea
                ...
                rows={5}
                className="w-full p-2 border rounded"
                placeholder="Enter corrective action content"
              />
            </div>
