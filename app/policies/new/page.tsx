...
export const metadata = {
  title: "New Policy | Business Smart Suite Portal",
  description: "Create a new policy",
}

export default function NewPolicyPageWrapper() {
  return (
    <Suspense fallback={<Loader overlay message="Loading new policy..." />}>
      <NewPolicyPage />
    </Suspense>
  )
}
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to create a category before adding a policy.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
    ...
    <div className="p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create a new policy document</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={createPolicy} className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <textarea
                ...
                rows={5}
                className="w-full p-2 border rounded"
                placeholder="Enter policy content or description"
              />
            </div>

            <div className="flex items-center space-x-2">
              <input id="highlighted" name="highlighted" type="checkbox" className="w-4 h-4" />
            ...
            <div className="flex items-center space-x-2">
              <input id="approved" name="approved" type="checkbox" className="w-4 h-4" />
