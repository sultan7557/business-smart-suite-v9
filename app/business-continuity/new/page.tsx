...
export default function NewBusinessContinuityPageWrapper() {
  return (
    <Suspense fallback={<Loader overlay message="Loading new business continuity..." />}>
      <NewBusinessContinuityPage />
    </Suspense>
  )
}

async function NewBusinessContinuityPage() {
