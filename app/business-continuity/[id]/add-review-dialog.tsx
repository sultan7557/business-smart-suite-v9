...
import { addBusinessContinuityReview } from "@/app/actions/business-continuity-actions"
...
export function AddReviewDialog({ businessContinuityId, open, onOpenChange }: AddReviewDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await addBusinessContinuityReview(businessContinuityId, {
        reviewerName,
