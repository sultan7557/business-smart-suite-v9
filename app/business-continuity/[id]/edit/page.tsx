...
export default async function EditBusinessContinuityPage({ params }: EditPageProps) {
  ...
  async function updateBusinessContinuity(formData: FormData) {
    "use server"
    ...
    redirect(`/business-continuity/${businessContinuityId}`)
  }
  ...
  return (
    <div className="p-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Edit Business Continuity</CardTitle>
          <CardDescription>Update business continuity details</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={updateBusinessContinuity} className="space-y-4">
            <div className="grid gap-2">
              ...
              <input
                ...
                defaultValue={businessContinuity.title}
                required
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                name="categoryId"
                className="w-full p-2 border rounded"
                defaultValue={businessContinuity.categoryId}
                required
              >
            ...
            <div className="grid gap-2">
              ...
              <input
                ...
                name="version"
                className="w-full p-2 border rounded"
                defaultValue={businessContinuity.version}
                required
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <input
                ...
                type="date"
                className="w-full p-2 border rounded"
                defaultValue={new Date(businessContinuity.issueDate).toISOString().split("T")[0]}
                required
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <input
                ...
                name="location"
                className="w-full p-2 border rounded"
                defaultValue={businessContinuity.location}
                required
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <textarea
                ...
                rows={5}
                className="w-full p-2 border rounded"
                defaultValue={businessContinuity.content || ""}
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                type="checkbox"
                className="w-4 h-4"
                defaultChecked={businessContinuity.highlighted}
              />
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                type="checkbox"
                className="w-4 h-4"
                defaultChecked={businessContinuity.approved}
              />
            ...
            <div className="flex justify-end">
              <Button type="submit">Update Business Continuity</Button>
            </div>
          </form>
        </CardContent>
      </Card>
