...
import { deleteBusinessContinuityReview } from "@/app/actions/business-continuity-actions"
...
export default function ReviewsSection({ businessContinuityId, reviews, canEdit }: ReviewsSectionProps) {
