...
import { addManagementReviewReview } from "@/app/actions/management-review-actions"
...
export function AddReviewDialog({ managementReviewId, open, onOpenChange }: AddReviewDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await addManagementReviewReview(managementReviewId, {
        reviewerName,
