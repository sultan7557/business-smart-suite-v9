...
import { deleteManagementReviewReview } from "@/app/actions/management-review-actions"
...
export default function ReviewsSection({ managementReviewId, reviews, canEdit }: ReviewsSectionProps) {
