...
async function NewManagementReviewPage() {
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to create a category before adding a management review.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
  ...
  async function createManagementReview(formData: FormData) {
    "use server"
    ...
    redirect(`/management-reviews/${managementReview.id}`)
  }
    ...
    <div className="p-6">
      <div className="mb-6">
        <Button variant="outline" asChild>
          <Link href="/management-reviews" className="flex items-center">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Add New Management Review</CardTitle>
          <CardDescription>Create a new management review document</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={createManagementReview} className="space-y-4">
            <div className="grid gap-2">
              ...
              <input
                ...
                placeholder="Enter management review title"
                required
              />
            </div>
            ...
            <div className="flex justify-end">
              <Button type="submit">Create Management Review</Button>
            </div>
          </form>
        </CardContent>
      </Card>
