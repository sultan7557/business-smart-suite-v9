...
export const metadata = {
  title: "New Form | Business Smart Suite Portal",
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to create a category before adding a form.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
    ...
    <div className="p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create a new form document</CardDescription>
        </CardHeader>
        <CardContent>
