...
import { addHseGuidanceReview } from "@/app/actions/hse-guidance-actions"
...
export function AddReviewDialog({ hseGuidanceId, open, onOpenChange }: AddReviewDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await addHseGuidanceReview(hseGuidanceId, {
        reviewerName,
