...
import { addRegisterReview } from "@/app/actions/register-actions"
...
export function AddReviewDialog({ registerId, open, onOpenChange }: AddReviewDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (nextReviewDate) {
        formData.append("nextReviewDate", nextReviewDate)
      }
      formData.append("details", details)

      const result = await addRegisterReview(formData)
