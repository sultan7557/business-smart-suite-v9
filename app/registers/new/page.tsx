...
export default function NewRegisterPageWrapper() {
  return (
    <Suspense fallback={<Loader overlay message="Loading new register..." />}>
      <NewRegisterPage />
    </Suspense>
  )
}
...
async function NewRegisterPage() {
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to create a category before adding a register.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
  ...
  async function createRegister(formData: FormData) {
    "use server"
    ...
    redirect(`/registers/${register.id}`)
  }
    ...
    <div className="p-6">
      <div className="mb-6">
        <Button variant="outline" asChild>
          <Link href="/registers" className="flex items-center">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Add New Register</CardTitle>
          <CardDescription>Create a new register document</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={createRegister} className="space-y-4">
