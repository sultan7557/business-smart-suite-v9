...
import { addEnvironmentalGuidanceReview } from "@/app/actions/environmental-guidance-actions"
...
export default function AddReviewDialog({ environmentalGuidanceId, open, onOpenChange }: AddReviewDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await addEnvironmentalGuidanceReview(environmentalGuidanceId, {
        ...formData,
