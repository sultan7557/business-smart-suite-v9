...
export default function NewEnvironmentalGuidancePageWrapper() {
  return (
    <Suspense fallback={<Loader overlay message="Loading new environmental guidance..." />}>
      <NewEnvironmentalGuidancePage />
    </Suspense>
  )
}
