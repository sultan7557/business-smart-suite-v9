...
import { deleteJobDescriptionReview } from "@/app/actions/job-description-actions"
...
export default function ReviewsSection({ jobDescriptionId, reviews, canEdit }: ReviewsSectionProps) {
