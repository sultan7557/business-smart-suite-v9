...
import { addCOSHHReview } from "@/app/actions/coshh-actions"
...
export default function AddReviewDialog({ coshhId, open, onOpenChange }: AddReviewDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await addCOSHHReview(coshhId, {
        ...formData,
