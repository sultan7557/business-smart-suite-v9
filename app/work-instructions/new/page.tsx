...
export default function NewWorkInstructionPageWrapper() {
  return (
    <Suspense fallback={<Loader overlay message="Loading new work instruction..." />}>
      <NewWorkInstructionPage />
    </Suspense>
  )
}

async function NewWorkInstructionPage() {
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to create a category before adding a work instruction.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
  ...
  async function createWorkInstruction(formData: FormData) {
    "use server"
    ...
    redirect(`/work-instructions/${workInstruction.id}`)
  }
    ...
    <div className="p-6">
      <div className="mb-6">
        <Button variant="outline" asChild>
          <Link href="/work-instructions" className="flex items-center">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Add New Work Instruction</CardTitle>
          <CardDescription>Create a new work instruction document</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={createWorkInstruction} className="space-y-4">
