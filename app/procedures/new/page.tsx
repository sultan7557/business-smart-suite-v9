...
export default function NewProcedurePageWrapper() {
  return (
    <Suspense fallback={<Loader overlay message="Loading new procedure..." />}>
      <NewProcedurePage />
    </Suspense>
  )
}

async function NewProcedurePage() {
      ...
      <div className="p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to create a category before adding a procedure.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
    ...
    <div className="p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create a new procedure document</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={createProcedure} className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <textarea
                ...
                rows={5}
                className="w-full p-2 border rounded"
                placeholder="Enter procedure content"
              />
            </div>
