...
// export default function DocumentUpload({ entityId, entityType, onUploadComplete }: DocumentUploadProps) {
...
//         <CardDescription>Upload a new document or a new version of an existing document</CardDescription>
//       </CardHeader>
//       <CardContent>
//         {error && (
    ...
    try {
      ...
      setTimeout(() => {
        if (entityId && entityType) {
          // Redirect to the appropriate entity page based on entityType
          switch (entityType) {
            case "policy":
              router.push(`/policies/${entityId}`)
              break
            case "manual":
              router.push(`/manual/${entityId}`)
              break
            case "procedure":
              router.push(`/procedures/${entityId}`)
              break
            case "form":
              router.push(`/forms/${entityId}`)
              break
            case "legal-register":
              router.push(`/legal-register/${entityId}`)
              break
            case "improvement-register":
              router.push(`/improvement-register/${entityId}`)
              break
            default:
              router.refresh()
          }
