...
export default function CertificateForm({ certificate, canEdit }: CertificateFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    highlighted: certificate.highlighted || false,
    approved: certificate.approved || false,
