...
import { addFormVersion } from "@/app/actions/form-actions"

interface FormVersionFormProps {
  formId: string
...
export default function FormVersionForm({
  formId,
  currentVersion,
  onComplete,
  documentId,
}: FormVersionFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await addFormVersion(formId, formData)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Create a new version of this form</CardDescription>
      </CardHeader>
