...
export default function RiskAssessmentForm({ riskAssessment, canEdit }: RiskAssessmentFormProps) {
  const router = useRouter()
  const [isEditing, setIsEditing] = useState(false)
  const [formData, setFormData] = useState({
    title: riskAssessment.title,
    version: riskAssessment.version,
    reviewDate: new Date(riskAssessment.reviewDate).toISOString().split("T")[0],
    ...
    highlighted: riskAssessment.highlighted || false,
