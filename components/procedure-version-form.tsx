...
import { addProcedureVersion } from "@/app/actions/procedure-actions"

interface ProcedureVersionFormProps {
  procedureId: string
...
export default function ProcedureVersionForm({
  procedureId,
  currentVersion,
  onComplete,
  documentId,
}: ProcedureVersionFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await addProcedureVersion(procedureId, formData)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Create a new version of this procedure</CardDescription>
      </CardHeader>
