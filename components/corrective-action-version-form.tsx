...
import { addCorrectiveActionVersion } from "@/app/actions/corrective-action-actions"

interface CorrectiveActionVersionFormProps {
...
export default function CorrectiveActionVersionForm({
  correctiveActionId,
  currentVersion,
  onComplete,
  documentId,
}: CorrectiveActionVersionFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await addCorrectiveActionVersion(correctiveActionId, formData)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Create a new version of this corrective action</CardDescription>
      </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          {documentId && (
            <div className="p-3 bg-gray-50 rounded-md">
              <p className="text-sm text-gray-600">This version will be linked to the document you just uploaded.</p>
            </div>
          )}
        </CardContent>
